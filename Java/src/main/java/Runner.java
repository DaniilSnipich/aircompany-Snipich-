...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        PassengerPlane maxCapacityPlane = passengerAirport.getPassengerPlaneWithMaxPassengersCapacity();
        System.out.println("Plane with max passenger capacity: " + maxCapacityPlane);
    }
}
